...
input_data = np.load("../floatsData/fullFloats32_input_data.npy")
output_data = np.load("../floatsData/fullFloats32_output_data.npy")
...
savedModel = "../floatsData/savedModels/fullFloat32predictionModel5Layers.pth"  # <- path to save model
