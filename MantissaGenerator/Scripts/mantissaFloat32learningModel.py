...
input_data = np.load("/Users/maxsniezek/PycharmProjects/isingModelGAN/MantissaGenerator/floatsData/input_data.npy")
output_data = np.load("/Users/maxsniezek/PycharmProjects/isingModelGAN/MantissaGenerator/floatsData/output_data.npy")
...
savedModel = "/Users/maxsniezek/PycharmProjects/isingModelGAN/MantissaGenerator/floatsData/savedModels/float32predictionModel5Layers.pth"  # <- path to save model
...
class Float32Predictor(nn.Module):
    def __init__(self):
        ...
        self.main = nn.Sequential(
            ...
            nn.Linear(in_features=128, out_features=23),
            nn.Sigmoid(),
