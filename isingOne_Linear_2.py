...
batch_size = 12500
latent_dim = 16
noise_dim = 2  # <- size of input noise
lr = 0.0002

savedModel = "isingOneLinear2.pth"  # <- path to save model
savedDataPath = "outIsingData/outputDataTestFileLinear2.npy"  # <-path to save the data
