...
noise_dim = 8  # <- size of input noise
lr = 0.0002

savedModel = "isingOne(32-0150)Linear[8].pth"  # <- path to save model
savedDataPath = "outIsingData/outputData(32-0150)TestFileLinear[8].npy"  # <-path to save the data
